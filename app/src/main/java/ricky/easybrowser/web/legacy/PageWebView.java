...
public class PageWebView extends FrameLayout implements IWebView {
    ...
    /**
     * Bấm vào cửa sổ bật lên hình ảnh
     */
    ...
    /**
     * Nhấp vào cửa sổ bật lên liên kết web
     */
    ...
    /**
     * Hoạt ảnh dịch mượt mà hơn và khả năng phán đoán của cử chỉ kéo xuống cần được tối ưu hóa để tránh hiện tượng phần cuối trang web thường xuyên bị ẩn.
     * Tự động điều chỉnh phương thức LayoutParam để thường xuyên gọi requestLayout, dẫn đến hiệu suất hơi kém
     */
